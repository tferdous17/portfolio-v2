      ...
      <div className="flex gap-3 mt-auto items-center">
        <a href={githubLink} target="_blank">
          <svg
            ...
            class="icon icon-tabler icons-tabler-outline icon-tabler-brand-github hover:scale-110 hover:shadow-lg hover:text-green-300 transition-all duration-300 ease-in-out"
          >
